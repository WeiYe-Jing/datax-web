...
public class JobFileAppender {
    ...
    public static final InheritableThreadLocal<String> cxtHolder = new InheritableThreadLocal<String>();
     ...
     * @return
     */
    public static String mkLogFileName(Date triggerDate, long logId) {
     ...
     * @return log content
     */
    public static LogResult read(String logFileName, int fromLineNum) {
        ...
        // read file
        StringBuilder logCxt = new StringBuilder();
        int toLineNum = 0;
        ...
        // result
        return new LogResult(fromLineNum, toLineNum, logCxt.toString(), false);
		/*

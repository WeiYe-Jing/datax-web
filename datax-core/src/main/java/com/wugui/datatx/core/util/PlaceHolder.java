...
public class PlaceHolder {
    ...
    public static void main(String[] args) {
        String sss = "{\"job\":{\"content\":[{\"reader\":{\"parameter\":{\"password\":\"1e96a73a48c66720299872fa9c89b3317b0f79964952e2297f61daf28ba6755a\",\"column\":[\"`id`\"],\"where\":\"id >= ${startId}\",\"connection\":[{\"jdbcUrl\":[\"jdbc:mysql://m1.devops.longbridge.xyz:3306/bi?useUnicode=true&characterEncoding=UTF-8&useSSL=false\"],\"table\":[\"t_ds_version\"]}],\"splitPk\":\"\",\"username\":\"bi_ro_all\"},\"name\":\"mysqlreader\"},\"writer\":{\"parameter\":{\"password\":\"1e96a73a48c66720299872fa9c89b3317b0f79964952e2297f61daf28ba6755a\",\"column\":[\"`id`\"],\"connection\":[{\"jdbcUrl\":\"jdbc:mysql://m1.devops.longbridge.xyz:3306/bi?useUnicode=true&characterEncoding=UTF-8&useSSL=false\",\"table\":[\"t_ds_version\"]}],\"username\":\"bi_ro_all\"},\"name\":\"mysqlwriter\"}}],\"setting\":{\"errorLimit\":{\"record\":0,\"percentage\":0.02},\"speed\":{\"byte\":1048576,\"channel\":1}}}}";
        System.out.println(format(sss, MapUtil.of("startId","'1'")));
    }
    /**
     * 使用环境变量替换值
     * @param template

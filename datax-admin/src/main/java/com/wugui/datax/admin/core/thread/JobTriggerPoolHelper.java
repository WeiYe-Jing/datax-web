...
public class JobTriggerPoolHelper {
    ...
    public void addTrigger(final int jobId,
                           ...
                           final String addressList,String jobParam) {
        ...
        triggerPool_.execute(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    // do trigger
                    XxlJobTrigger.trigger(jobId, triggerType, failRetryCount, executorShardingParam, executorParam, addressList,jobParam);
                } catch (Exception e) {
                    logger.error(e.getMessage(), e);
                } finally {
     ...
     *                              not null: cover job param
     */
    public static void trigger(int jobId, TriggerTypeEnum triggerType, int failRetryCount, String executorShardingParam, String executorParam, String addressList,String jobParam) {
        helper.addTrigger(jobId, triggerType, failRetryCount, executorShardingParam, executorParam,addressList,jobParam);
    }
